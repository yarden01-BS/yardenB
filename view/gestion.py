...
class GestionEleves(ctk.CTk):
    def __init__(self):
        ...
        self.lbl_titre = ctk.CTkLabel(
            self, text="TABLEAU DE GESTION", font=ctk.CTkFont(size=24, weight="bold")
        )
        ...
        for i, (text, var) in enumerate(fields):
            ctk.CTkLabel(
                self.form_frame, text=text, font=ctk.CTkFont(weight="bold")
        ...
        ctk.CTkLabel(
            self.form_frame,
            text="SITUATION (Mois/9) :",
            font=ctk.CTkFont(weight="bold"),
        ).grid(row=9, column=0, padx=10, pady=5, sticky="w")
        self.slider_fin = ctk.CTkSegmentedButton(
            self.form_frame,
        ...
        self.search_entry = ctk.CTkEntry(
            self.btn_frame, placeholder_text="Matricule..."
        )
        self.search_entry.pack(pady=5, fill="x")
        ctk.CTkButton(
            self.btn_frame, text="Recherche", fg_color="#89b4fa", text_color="#1e1e2e"
        ).pack(pady=5, fill="x")
